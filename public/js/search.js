...
search.ac = function(q){
    ...
    search.xhr = $.post( "/ac", {
        ...
        for (product in response) {
            search.r.append('<a class="list-group-item" href="' + response[product].url + '">' + response[product].name + '</a>');
        }
    });
};
...
search.go = function(q){
    ...
    search.xhr = $.post( "/search", {
        ...
        for (product in response) {
            search.fr.append('<a class="list-group-item" href="#"><strong>' + response[product].name + '</strong></a>');
        }
    });
};
